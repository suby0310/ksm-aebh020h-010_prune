/***************************************************************************************
   ...
   si46xx bootloader mini patch to enable access to NVSPI connected flash
   FILE: si46xx_rom00_mini_patch.h
   Supported IC : Si468x
   Date: June 20 2014
  (C) Copyright 2014, Silicon Laboratories, Inc. All rights reserved.
****************************************************************************************/

#ifndef __MINIPATCH__
#define __MINIPATCH__

#include "common_types.h"
#include "platform_options.h"

#define MINIPATCH_LENGTH 940

//This,is,the,minipatch_003.bin
//Declaring,in,code,space,to,save,RAM,and,to,ensure,we,dont,hit,a,watchdog,timeout,during,variable,init,(prior,to,entering,main())
MEMORY_SPACE__CODE uint8_t minipatch[MINIPATCH_LENGTH]={
